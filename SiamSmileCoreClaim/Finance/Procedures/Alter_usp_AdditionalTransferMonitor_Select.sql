USE [CoreClaim]
GO
/****** Object:  StoredProcedure [finance].[usp_AdditionalTransferMonitor_Select]    Script Date: 9/4/2026 3:49:20 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [finance].[usp_AdditionalTransferMonitor_Select] 
